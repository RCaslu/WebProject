...
for (const produtoCatalogo of catalago) {
    const cartaoProduto = `<div class='border-solid shadow-xl shadow-slate-400 w-48 m-2 flex flex-col p-2 justify-between group rounded-lg ${produtoCatalogo.feminino ? 'feminino': 'masculino'}' id="card-produto-${produtoCatalogo.id}">
<img 
    src="./assets/img/${produtoCatalogo.nomeArquivoImagem}" 
    alt="Produto 1 do caslu market."
